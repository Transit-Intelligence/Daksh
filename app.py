...
image_path = "C:/Users/Welcome/OneDrive - Transit Intelligence/Desktop/App_final_pradeep/image_bg.png"
...
with col1:
    ...
    st.image("https://media.licdn.com/dms/image/v2/C560BAQFQHKkAhLLpiQ/company-logo_200_200/company-logo_200_200/0/1630642787092?e=1737590400&v=beta&t=4J5VrTf2fORgccF4PnYYCRl3oM6_mYUQ4YH49wIZ4WM", width=100)  # Adjust width as needed
with col2:
    # Display company image
    st.image("https://upload.wikimedia.org/wikipedia/en/4/4c/Official_Logo_of_IIT%28BHU%29%2CVaranasi%2CIndia%2C2013.png", width=100)  # Adjust width as needed
with col3:
    # st.set_page_config(layout="wide", page_title="DAKSH tool for bus service planning and scheduling")
    ...
    # Initialize session state variables for the page
        ...
        if selected == 'Bus Scheduling':
            ...
            station_list_file = UPLOAD_FOLDER / "stops.txt"
            ...
            if stop_times_file.exists() and stops_v3_file.exists() and station_list_file.exists():
                ...
                stations = pd.read_csv(station_list_file,delimiter =',')
